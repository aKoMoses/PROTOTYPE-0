...
export const content = {
  ...
  abilities: {
    ...
    blinkStep: { key: "blinkStep", name: "Blink Step", role: "Mobility", description: "Retired from the competitive pool. The current ruleset favors committed spacing tools over free blinks.", icon: "ability-blink", category: "mobility", state: "locked" },
    magneticGrapple: {
      key: "magneticGrapple",
      name: "Magnetic Grapple",
      input: "Q",
      role: "Engage / Catch",
      description: "Fire a real magnetic hook, drag the target in, then recast to cut the pull at the spacing you want.",
    ...
    shockJavelin: {
      ...
      input: "Q",
      role: "Punish / Combo",
      description: "Electrify on hit, then recast to blink behind the slowed target before the window expires.",
    ...
    pulseBurst: {
      ...
      description: "Fire a guided pulse volley that rewards clean setup. More missiles on the same target deal sharply higher damage, and a full connect ignites Burn.",
      icon: "ability-burst",
      category: "offense",
      state: "playable",
    },
    railShot: { key: "railShot", name: "Rail Shot", role: "Offense", description: "Retired from the competitive pool. The Rail Sniper now owns the long-range punish identity cleanly.", icon: "ability-rail", category: "offense", state: "locked" },
    ...
    magneticField: {
      ...
      description: "Create a larger distortion field that drags hostile projectiles down and opens dodge windows without deleting them outright.",
      icon: "ability-field",
      category: "control",
      state: "playable",
    },
    gravityWell: { key: "gravityWell", name: "Gravity Well", role: "Control", description: "Living singularity that drags targets inward and turns exits into bad trades.", icon: "ability-gravity", category: "control", state: "playable" },
    ...
    energyShield: {
      ...
      description: "Time a compact shield to absorb burst, block incoming control while it holds, and earn cooldown back if the enemy commits enough damage to break it.",
      icon: "ability-shield",
      category: "defense",
      state: "playable",
    },
  energyParry: {
    ...
    description: "Enter a 0.45s parry stance. If hit, negate the attack, blink behind the attacker, gain 18 shield, 20% move speed for 1s, and empower your next hit for +14 damage.",
    icon: "ability-phaseshift",
    category: "defense",
    state: "playable",
  },
    phaseShift: { key: "phaseShift", name: "Phase Shift", role: "Defense", description: "Short pure-escape intangibility. Purges debuffs, but locks out attacks and spells while phased.", icon: "ability-phaseshift", category: "defense", state: "playable" },
  ...
  perks: {
    omnivampCore: { key: "omnivampCore", name: "Omnivamp Core", description: "Restore health from your confirmed damage. Broad sustain, no gimmick.", icon: "perk-vamp", state: "playable" },
    ...
    lastStandBuffer: { key: "lastStandBuffer", name: "Baroud d'Honneur", description: "Once per round lethal damage overloads you into a 3 second do-or-die sprint.", icon: "perk-laststand", state: "playable" },
    precisionMomentum: { key: "precisionMomentum", name: "Precision Momentum", description: "Confirmed auto attacks stack damage for the next one. Missing drops the chain.", icon: "perk-momentum", state: "playable" },
