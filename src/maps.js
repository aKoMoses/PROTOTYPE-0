...
const mapLayouts = {
  ...
  trainingExpanse: {
    ...
    height: 2000,
    scrollable: true,
    playerSpawn: { x: 320, y: 1000 },
    enemySpawn: { x: 3280, y: 1000 },
    trainingSpawn: { x: 320, y: 1000 },
    survivalSpawns: [],
    arenaDecor: [
      { type: "lane", x: 180, y: 820, w: 3240, h: 320, color: "rgba(111, 142, 164, 0.07)", stroke: "rgba(173, 223, 252, 0.12)" },
      { type: "lane", x: 240, y: 320, w: 3120, h: 140, color: "rgba(111, 142, 164, 0.04)", stroke: "rgba(173, 223, 252, 0.08)" },
      { type: "lane", x: 240, y: 1540, w: 3120, h: 140, color: "rgba(111, 142, 164, 0.04)", stroke: "rgba(173, 223, 252, 0.08)" },
      { type: "bridge", x: 960, y: 900, w: 420, h: 180, color: "rgba(84, 104, 122, 0.06)", stroke: "rgba(173, 223, 252, 0.10)" },
      { type: "bridge", x: 2220, y: 900, w: 420, h: 180, color: "rgba(84, 104, 122, 0.06)", stroke: "rgba(173, 223, 252, 0.10)" },
      { type: "pit", x: 1580, y: 860, w: 420, h: 240, color: "rgba(7, 13, 20, 0.48)", stroke: "rgba(130, 212, 255, 0.16)" },
    ],
    obstacles: [
      { key: "expanse-block-1", x: 1040, y: 640, w: 140, h: 120, style: "core-block" },
      { key: "expanse-block-2", x: 1040, y: 1240, w: 140, h: 120, style: "core-block" },
      { key: "expanse-block-3", x: 2420, y: 640, w: 140, h: 120, style: "core-block" },
      { key: "expanse-block-4", x: 2420, y: 1240, w: 140, h: 120, style: "core-block" },
      { key: "expanse-pillar-1", x: 1460, y: 842, w: 76, h: 286, style: "bridge-pillar" },
      { key: "expanse-pillar-2", x: 1740, y: 842, w: 76, h: 286, style: "bridge-pillar" },
      { key: "expanse-cover-1", x: 640, y: 924, w: 180, h: 92, style: "gallery-wall" },
      { key: "expanse-cover-2", x: 2780, y: 924, w: 180, h: 92, style: "gallery-wall" },
    ],
    bushes: [],
    portals: [],
    pylons: [],
