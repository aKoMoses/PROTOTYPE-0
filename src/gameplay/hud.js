...
import { getBuildStats, hasPerk, getAbilityBySlot, getActiveDashCooldown, getPulseMagazineSize, getStatusDuration } from "../build/loadout.js";
...
export function updateHud() {
  ...
  if (playerBuildTag) {
    ...
    playerBuildTag.textContent = player.lastStandTime > 0
      ? `${perkName} | OVERLOAD ${player.lastStandTime.toFixed(1)}s`
      : perkName;
