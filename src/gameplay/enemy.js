...
export function updateEnemy(dt) {
  ...
  if (canUseOffensiveAbility && enemyHasAbility("shockJavelin") && enemy.javelinCooldown <= 0 && distance > 180 && distance < 620) {
  ...
  if (canUseDefensiveAbility && enemyHasAbility("backstepBurst") && enemy.abilityCooldowns.backstep <= 0 && (enemyLow || (targetOnAxe && distance < 170))) {
    castEnemyBackstep();
  }

  if (canUseOffensiveAbility && enemyHasAbility("blinkStep") && enemy.abilityCooldowns.blink <= 0 && distance > targetRange + 140) {
  ...
  if (canUseOffensiveAbility && enemyHasAbility("gravityWell") && enemy.abilityCooldowns.gravityWell <= 0 && distance > 180 && distance < 420 && (playerExposed || targetOnAxe)) {
    castEnemyGravityWell(focusTargetEntity);
  }

  if (canUseDefensiveAbility && enemyHasAbility("phaseShift") && enemy.abilityCooldowns.phaseShift <= 0 && (enemyLow || incomingProjectile)) {
    castEnemyPhaseShift();
  }

  if (canUseDefensiveAbility && enemyHasAbility("hologramDecoy") && enemy.abilityCooldowns.hologramDecoy <= 0 && enemyLow) {
    castEnemyHologram();
  }

  if (canUseOffensiveAbility && enemyHasAbility("speedSurge") && enemy.abilityCooldowns.speedSurge <= 0 && (shouldPunish || distance > targetRange + 90)) {
    castEnemySpeedSurge();
  }
  ...
  } else if (canUseOffensiveAbility && enemyHasAbility("pulseBurst") && enemy.abilityCooldowns.pulseBurst <= 0 && distance < 320 && shouldPunish) {
